...
//     const [username, setUsername] = useState('');
//     const [password, setPassword] = useState('');
//     const {signin, isLoading, error, errorFields} = useSignin();
...
//     return (
//         <div className="mx-auto mt-[20vh] z-50 relative border-2 bg-white border-secondary rounded-xl p-6 pb-1 max-w-[95vw] w-[400px] animate-slideIn">
//             <form>
...
//                         <p className='text-primary cursor-pointer' onClick={() => navigate('/signup')}>
//                             Sign Up
//                         </p> 
//                     </span>
//                 </div>
//             </form>
//             <div className="mt-10">
//                 <p className="text-center text-default-500 text-sm cursor-pointer">
...
//                 {/* <div>
//                     <div className="flex items-center justify-between w-[98%] h-6 mt-7 mx-auto">
