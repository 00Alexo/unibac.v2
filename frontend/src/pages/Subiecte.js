...
const Subiecte = () => {
    ...
    const getSubiecte = async () => {
        setLoading(true);
        const response = await fetch(`${process.env.REACT_APP_API}/api/subiecte/getSubiecte`, {
            method: 'get',
            headers: {
    ...
    return (
        ...
        <div key={subiect._id} className="flex-[1_1_calc(25%-1.5rem)] min-w-[250px]" onClick={() => navigate(`/subiecte/${subiect._id}`)}>
