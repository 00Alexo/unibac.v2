...
const SignUp = () => {
    ...
    const handleSubmit = () =>{
        signup(username, email, statut, password, confirmPassword);
    }
            ...
            <form>
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex w-full flex-wrap md:flex-nowrap md:mb-0">
                        ...
                        value={email}
                        label="Email" type="email" variant="bordered" isClearable/>
                    </div>
                    <div className="flex w-full flex-wrap md:flex-nowrap md:mb-0">
                        <Select required
                ...
                <div className="text-center mt-2">
                    <span>Already have an account?
                        <p className='text-primary cursor-pointer' onClick={() => navigate('/signin')}>
                            Sign In
                        </p> 
                    </span>
                </div>
